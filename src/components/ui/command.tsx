...
>(({ className, ...props }, ref) => (
  ...
  <div className="flex items-center border-b border-[#27272a] px-3" cmdk-input-wrapper="">
...
const CommandShortcut = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement> & { className?: string }) => {
